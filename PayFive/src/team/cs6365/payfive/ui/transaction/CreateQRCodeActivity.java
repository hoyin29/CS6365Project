...
public class CreateQRCodeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// barcode data
		String[] strings = getIntent().getStringArrayExtra(
				NewTransactionFragment.EXTRA_QR_INFO);
		String barcode_data = strings[1] + ";" + strings[2] + ";" + strings[3]
				+ ";" + strings[0];

		// barcode image
		Bitmap bitmap = null;
		try {
			bitmap = encodeAsBitmap(barcode_data, BarcodeFormat.QR_CODE, 200,
					200);
		} catch (WriterException e) {
			e.printStackTrace();
		}
		// Bitmap bitmap = BitmapFactory.decodeByteArray(out.toByteArray(), 0,
